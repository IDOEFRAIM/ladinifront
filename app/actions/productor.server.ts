...
export async function updateProducerSettings(userId: string, producerId: string, data: { name?: string; email?: string; phone?: string; location?: string; whatsappEnabled?: boolean; latitude?: number; longitude?: number; cnibNumber?: string }) {

...
import { getFarms, getStocks } from '@/features/inventory/actions/inventory.actions';
import FarmList from '@/features/inventory/components/FarmList';
import StockBoard from '@/features/inventory/components/StockBoard';

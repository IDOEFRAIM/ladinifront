...
export function aggregateQuantities(items: CreateOrderParams['items']): Map<string, number> {
 ...
 */
export function mapPaymentMethodCode(method?: string): string {
 ...
 */
export async function validateInventory(tx: any, items: CreateOrderParams['items']): Promise<Map<string, ProductInventoryCheck>> {
 ...
 */
export async function createOrderRecord(tx: any, data: CreateOrderParams, paymentMethodCode: string): Promise<OrderCreated> {
 ...
 */
export async function decrementStock(tx: any, items: CreateOrderParams['items']): Promise<void> {
  const requiredByProductId = aggregateQuantities(items);
